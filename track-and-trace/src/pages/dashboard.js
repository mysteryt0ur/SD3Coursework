                ...
                <div id="button-holder">
                  <div className="row">
                    <div
                      ...
                      id="venue-button"
                      onClick={() => this.showPage("venueCheckIn")}
                    >
                      <img
                        src={venueIcon}
                        alt="venue-icon"
                    ...
                    <div
                      ...
                      id="results-button"
                      onClick={() => this.showPage("inputTestResult")}
                    >
                      <img
                        src={resultIcon}
                        alt="results-icon"
                  ...
                  <div className="row">
                    ...
                    <div
                      className="button-two"
                      id="about-button"
                      onClick={() => this.showPage("aboutPage")}
                    >
                      <img
                        src={aboutIcon}
                        alt="about-icon"
