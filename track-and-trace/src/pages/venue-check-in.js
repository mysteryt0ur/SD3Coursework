          ...
          <div className="content-inner-addit-page">
            <div className="page-info-venue">
              {this.state.useCamera === "true" && (
                <div>
                  <p>
                    Use your devices camera to place the QR code into the box
                    below
                  </p>
                </div>
              )}
              {this.state.useCamera === "false" && (
                <div>
                  <p>
                    Use the input box below to enter the code of the venue you
                    want to check-into
                  </p>
                </div>
              )}
            ...
            <div className="page-info-venue-two" id="vci-other-input-option">
              {this.state.useCamera === "true" && (
                <div>
                  <p
                    id="vci-option-2"
                    onClick={() => this.changeUseCamera("false")}
                  >
                    Click here to enter the code manually
                  </p>
                </div>
              )}
              {this.state.useCamera === "false" && (
                <div>
                  <p
                    id="vci-option-2"
                    onClick={() => this.changeUseCamera("true")}
                  >
                    Click here to enter the code via camera
                  </p>
                </div>
              )}
            </div>
            ...
            <form id="venue-form-input">
              {this.state.useCamera === "false" && (
                <div>
                  <label id="input-test-code">
                    ...
                    <input
                      type="text"
                      value={this.state.currentVenueCode}
                      name="name"
                      className="text-input"
                      onChange={this.updateCurrentCode}
                    />
                  </label>
                  {this.getInputtedCodeLength() === true && (
                    <div>
                      ...
                      <p id="positive-message">
                        <b>If this correct</b>, please click the continue button
                        below.
                      </p>
                      <p id="negative-message">
                        <b>If this is not the right venue</b>, please check
                        couble check the code you have entered.
                      </p>
                    </div>
                  )}
                </div>
              ...
              <div className="submit-button-positioner">
                <div
                  className="submit-button-holder"
                  onClick={() => this.changeCheckInStatus("true")}
                >
